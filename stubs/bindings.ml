...
module C (F : Cstubs.FOREIGN) = struct
  ...
  module Jl_module = struct
    ...
    let create = foreign "ml_jl_new_module" (Jl_sym.t @-> t @-> returning t)
  ...
  module Jl_value = struct
    ...
    let box_float64 = foreign "jl_box_float64" (double @-> returning t)
    ...
    let unbox_float64 = foreign "jl_unbox_float64" (t @-> returning double)
